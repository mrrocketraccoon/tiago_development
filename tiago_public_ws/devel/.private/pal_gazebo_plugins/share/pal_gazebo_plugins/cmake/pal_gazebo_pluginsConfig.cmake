...
if("TRUE" STREQUAL "TRUE")
  set(pal_gazebo_plugins_SOURCE_PREFIX /tiago_public_ws/src/pal_gazebo_plugins)
  set(pal_gazebo_plugins_DEVEL_PREFIX /tiago_public_ws/devel/.private/pal_gazebo_plugins)
  ...
  set(pal_gazebo_plugins_INSTALL_PREFIX /tiago_public_ws/install)
...
if(NOT "/tiago_public_ws/src/pal_gazebo_plugins/include;/usr/include;/usr/include/gazebo-9;/usr/include/bullet;/usr/include/simbody;/usr/include/sdformat-6.0;/usr/include/ignition/math4;/usr/include/OGRE;/usr/include/OGRE/Terrain;/usr/include/OGRE/Paging;/usr/include/ignition/transport4;/usr/include/ignition/msgs1;/usr/include/ignition/common1;/usr/include/ignition/fuel_tools1 " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pal_gazebo_plugins' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tiago_public_ws/src/pal_gazebo_plugins/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /tiago_public_ws/devel/.private/pal_gazebo_plugins/lib;/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
