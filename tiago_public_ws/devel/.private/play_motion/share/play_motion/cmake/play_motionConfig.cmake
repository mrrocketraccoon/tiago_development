...
if("TRUE" STREQUAL "TRUE")
  set(play_motion_SOURCE_PREFIX /tiago_public_ws/src/play_motion/play_motion)
  set(play_motion_DEVEL_PREFIX /tiago_public_ws/devel/.private/play_motion)
  ...
  set(play_motion_INSTALL_PREFIX /tiago_public_ws/install)
...
if(NOT "/tiago_public_ws/src/play_motion/play_motion/include " STREQUAL " ")
  set(play_motion_INCLUDE_DIRS "")
  set(_include_dirs "/tiago_public_ws/src/play_motion/play_motion/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'play_motion' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tiago_public_ws/src/play_motion/play_motion/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /tiago_public_ws/devel/.private/play_motion/lib;/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
