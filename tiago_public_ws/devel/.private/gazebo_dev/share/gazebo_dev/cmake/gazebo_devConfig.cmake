...
if("TRUE" STREQUAL "TRUE")
  set(gazebo_dev_SOURCE_PREFIX /tiago_public_ws/src/gazebo_ros_pkgs/gazebo_dev)
  set(gazebo_dev_DEVEL_PREFIX /tiago_public_ws/devel/.private/gazebo_dev)
  ...
  set(gazebo_dev_INSTALL_PREFIX /tiago_public_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gazebo_dev' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tiago_public_ws/src/gazebo_ros_pkgs/gazebo_dev/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /tiago_public_ws/devel/.private/gazebo_dev/lib;/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
...
set(pkg_cfg_extras "/tiago_public_ws/src/gazebo_ros_pkgs/gazebo_dev/cmake/gazebo_dev-extras.cmake")
