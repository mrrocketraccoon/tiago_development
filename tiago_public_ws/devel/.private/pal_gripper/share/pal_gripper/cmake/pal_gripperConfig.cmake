...
if("TRUE" STREQUAL "TRUE")
  set(pal_gripper_SOURCE_PREFIX /tiago_public_ws/src/pal_gripper/pal_gripper)
  set(pal_gripper_DEVEL_PREFIX /tiago_public_ws/devel/.private/pal_gripper)
  ...
  set(pal_gripper_INSTALL_PREFIX /tiago_public_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'pal_gripper' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tiago_public_ws/src/pal_gripper/pal_gripper/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /tiago_public_ws/devel/.private/pal_gripper/lib;/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
