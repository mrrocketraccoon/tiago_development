...
if("TRUE" STREQUAL "TRUE")
  set(velocity_controllers_SOURCE_PREFIX /tiago_public_ws/src/ros_controllers/velocity_controllers)
  set(velocity_controllers_DEVEL_PREFIX /tiago_public_ws/devel/.private/velocity_controllers)
  ...
  set(velocity_controllers_INSTALL_PREFIX /tiago_public_ws/install)
...
if(NOT "/tiago_public_ws/src/ros_controllers/velocity_controllers/include " STREQUAL " ")
  set(velocity_controllers_INCLUDE_DIRS "")
  set(_include_dirs "/tiago_public_ws/src/ros_controllers/velocity_controllers/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'velocity_controllers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tiago_public_ws/src/ros_controllers/velocity_controllers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /tiago_public_ws/devel/.private/velocity_controllers/lib;/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
