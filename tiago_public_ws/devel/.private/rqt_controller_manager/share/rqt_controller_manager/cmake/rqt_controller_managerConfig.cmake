...
if("TRUE" STREQUAL "TRUE")
  set(rqt_controller_manager_SOURCE_PREFIX /tiago_public_ws/src/ros_control/rqt_controller_manager)
  set(rqt_controller_manager_DEVEL_PREFIX /tiago_public_ws/devel/.private/rqt_controller_manager)
  ...
  set(rqt_controller_manager_INSTALL_PREFIX /tiago_public_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rqt_controller_manager' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tiago_public_ws/src/ros_control/rqt_controller_manager/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /tiago_public_ws/devel/.private/rqt_controller_manager/lib;/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
