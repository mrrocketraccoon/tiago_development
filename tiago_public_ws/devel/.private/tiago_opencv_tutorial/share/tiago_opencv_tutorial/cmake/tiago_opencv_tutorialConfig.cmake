...
if("TRUE" STREQUAL "TRUE")
  set(tiago_opencv_tutorial_SOURCE_PREFIX /tiago_public_ws/src/tiago_tutorials/tiago_opencv_tutorial)
  set(tiago_opencv_tutorial_DEVEL_PREFIX /tiago_public_ws/devel/.private/tiago_opencv_tutorial)
  ...
  set(tiago_opencv_tutorial_INSTALL_PREFIX /tiago_public_ws/install)
...
if(NOT "/tiago_public_ws/devel/.private/tiago_opencv_tutorial/include " STREQUAL " ")
  set(tiago_opencv_tutorial_INCLUDE_DIRS "")
  set(_include_dirs "/tiago_public_ws/devel/.private/tiago_opencv_tutorial/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tiago_opencv_tutorial' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tiago_public_ws/src/tiago_tutorials/tiago_opencv_tutorial/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /tiago_public_ws/devel/.private/tiago_opencv_tutorial/lib;/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
