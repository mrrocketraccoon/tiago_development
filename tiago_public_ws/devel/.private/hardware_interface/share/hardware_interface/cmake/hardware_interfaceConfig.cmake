...
if("TRUE" STREQUAL "TRUE")
  set(hardware_interface_SOURCE_PREFIX /tiago_public_ws/src/ros_control/hardware_interface)
  set(hardware_interface_DEVEL_PREFIX /tiago_public_ws/devel/.private/hardware_interface)
  ...
  set(hardware_interface_INSTALL_PREFIX /tiago_public_ws/install)
...
if(NOT "/tiago_public_ws/src/ros_control/hardware_interface/include " STREQUAL " ")
  set(hardware_interface_INCLUDE_DIRS "")
  set(_include_dirs "/tiago_public_ws/src/ros_control/hardware_interface/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'hardware_interface' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tiago_public_ws/src/ros_control/hardware_interface/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /tiago_public_ws/devel/.private/hardware_interface/lib;/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
