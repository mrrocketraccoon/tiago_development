...
if("TRUE" STREQUAL "TRUE")
  set(gmapping_SOURCE_PREFIX /tiago_public_ws/src/slam_gmapping/gmapping)
  set(gmapping_DEVEL_PREFIX /tiago_public_ws/devel/.private/gmapping)
  set(gmapping_INSTALL_PREFIX "")
  set(gmapping_PREFIX ${gmapping_DEVEL_PREFIX})
else()
  set(gmapping_SOURCE_PREFIX "")
  set(gmapping_DEVEL_PREFIX "")
  set(gmapping_INSTALL_PREFIX /tiago_public_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'gmapping' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/tiago_public_ws/src/slam_gmapping/gmapping/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /tiago_public_ws/devel/.private/gmapping/lib;/tiago_public_ws/devel/lib;/opt/ros/melodic/lib)
